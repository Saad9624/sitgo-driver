...
export default class previous_booking extends React.Component {
  ...
  booking_detail_call(sid){
      const baseUrl = baseurl.uatbaseurl + 'driverbookings/previousviewbookings?'
    //const baseUrl = "https://hitsofficialpk.com/sitgo/booking/newbookings?";
   const param = `busid=1&time=12:30:00&date=2020-01-21`;
